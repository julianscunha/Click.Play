...
## Corpus Check
- 159 files · ~37,809 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 581 nodes · 790 edges · 30 communities (29 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8972e97d`
...
Cohesion: 0.08
Nodes (39): ClickPlayDb, createDb(), toRow(), CostApprovalGate, createCostApprovalGate(), JobRunnerDeps, runJobOnce(), startJob() (+31 more)
...
## Knowledge Gaps
- **245 isolated node(s):** `name`, `version`, `private`, `type`, `main` (+240 more)
