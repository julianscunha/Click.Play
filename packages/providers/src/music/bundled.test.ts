...
describe("selectTrack", () => {
  ...
  it("falls back to any track when requested mood has no tracks (ex: playful_kids sem catálogo ainda)", () => {
    const result = selectTrack("playful_kids" as MusicMood);
    expect(result).not.toBeNull();
    expect(result!.requestedMood).toBe("playful_kids");
