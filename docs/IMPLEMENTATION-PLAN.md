...
Status: Fases 0–11 concluídas (auditoria, bootstrap, domain, LLM provider, Creative Director, TTS, produção visual, música, captions, VideoRenderer/RemotionRenderer, Job pipeline, WebUI MVP). Próxima: Fase 12 (Quality Control determinístico).
